...
* Домашка
 І знов ці п’ятнашки((
 Займаємось рефакторінгом коду.
 Таке життя девелопера: клієнт дає нове ТЗ, і тепер він хоче отримати
  п’ятнашки з наступними умовами: відвідувач сторінки задає розмір 
  сторони поля (тобто, наприклад, 4х4, 5х5). Варто ввести обмеження
   не більше 10 (тобто максимум 100 ячейок).
 2) Додаємо таблицю чемпіонів (тут нам допоможе json і localstorage):
  ім’я, витрачений на гру час, розмір поля.
 Всі правила гри зберігаються - одна ячейка порожня, і ми можемо 
 пересовувати на неї сусідні фішки. Коли наш користувач виграє, 
 радісно повідомити про перемогу, зберегти дані в таблицю чемпіонів.
* */
