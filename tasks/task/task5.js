...
function luckyNumber(number) {
    if( 1 <= number.length  <=  1018 ) {
			var arrLen = [4444, 4447, 4474, 4744, 4477, 4774, 4747,
				4777, 7444, 7447, 7477, 7744, 7747, 7777, 7747774,
				44444444447777777777474744747474747474747474];
			for (var i = 0; i < arrLen.length; i++) if (number % arrLen[i] === 0) return true;
			for (var j = 0; j < arrLen.length; j++) if (number % arrLen[j] !== 0) return false;
		} else {
			alert('Число не должно выходить за диапазон: 1 <= number.length  <=  1018!');
    }
}
