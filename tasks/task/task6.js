    ...
    if( 1000 <=  y  <= 9000 ) {
        ...
        for(var i = +y + 1; i <= 9000; i++) {
          var strYear = i.toString();
            ...
            if ( strYear[0] !== strYear[1] && strYear[0] !== strYear[2]
                && strYear[0] !== strYear[3] && strYear[1] !== strYear[2]
                && strYear[1] !== strYear[3] && strYear[2] !== strYear[3] ) {
			...
			alert('Число не должно выходить за диапазон: 1000 <=  y  <= 9000!');
		}
}
